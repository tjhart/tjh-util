...
public class DefaultBlockMapTests{
    ...
    public void before(){
        ...
        map = new DefaultBlockMap<String, Integer>(new Block2<DefaultBlockMap<String, Integer>, Object, Integer>(){
            public Integer invoke(DefaultBlockMap<String, Integer> map, Object key){
                invoked = true;
                return 3;
            }
        });
